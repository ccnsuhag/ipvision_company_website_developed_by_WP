...
function product_five_section(){

    vc_map(array(

        'name' => __('Products Five','ipvision'),
        'description' => 'this is slider addon',
        'base' => 'product_five_section',
        'category' => 'Ipvision',
...
add_action('vc_before_init','product_five_section');


function ipvision_product_five_section($attr){
 ...
 <section id='chat' class="pt-70 pb-70">
        <div class="container">
            ...
            <div class="row align-items-center">
			    <div class="col-lg-6">
                    <div class="service-img text-center" data-animate="fadeInUp" data-delay=".4">
                         <?php 
  $product_five_image = wp_get_attachment_image_src($image_one,'full');

  if($product_five_image ){ ?>

   <img src="<?php echo esc_url($product_five_image[0]);?>" alt="" data-rjs="2">
...
add_shortcode('product_five_section','ipvision_product_five_section');
