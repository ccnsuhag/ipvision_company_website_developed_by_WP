...
function solution_three_section(){

    vc_map(array(

        'name' => __('Solution Three','ipvision'),
        'description' => 'this is slider addon',
        'base' => 'solution_three_section',
        'category' => 'Ipvision',
...
add_action('vc_before_init','solution_three_section');


function ipvision_solution_three_section($attr){
 ...
 <section id='blockchain' class="pt-70 pb-70">
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="service-img text-center" data-animate="fadeInUp" data-delay=".4">
                        <?php 
  $solution_three_image = wp_get_attachment_image_src($image_one,'full');

  if($solution_three_image ){ ?>

   <img src="<?php echo esc_url($solution_three_image[0]);?>" alt="" data-rjs="2">
...
add_shortcode('solution_three_section','ipvision_solution_three_section');
